...
interface IEmployeeEditFormModel {
    employeeSqId: number;
    employeeId: string;
...
@viewForm('EmployeeEdit')
export class EmployeeEditFormModel implements  IEmployeeEditFormModel{
    employeeSqId: number;
    @fieldConstraint({
    ...
    projectTagging: ProjectTagging;
        constructor(employeeEditFormModel: IEmployeeEditFormModel = {
            employeeSqId: 0,
            employeeId: "",
            ...
            projectTagging: new ProjectTagging()
                    ...
                    this.employeeSqId = employeeEditFormModel.employeeSqId || 0;
                    this.employeeId = employeeEditFormModel.employeeId || "";
                    this.department = employeeEditFormModel.department || new Department();
                    this.account = employeeEditFormModel.account || new Account();
                    this.region = employeeEditFormModel.region || new Region();
                    this.location = employeeEditFormModel.location || new Location();
                    this.employeeName = employeeEditFormModel.employeeName || '';
                    this.mobileNum = employeeEditFormModel.mobileNum || null;
                    this.emailId = employeeEditFormModel.emailId || '';
                    this.grade = employeeEditFormModel.grade || new Grade();
                    this.designation = employeeEditFormModel.designation || new Designation();
                    this.reportingManager = employeeEditFormModel.reportingManager || '';
                    this.previousExp = employeeEditFormModel.previousExp || null;
                    this.joiningDate = employeeEditFormModel.joiningDate || '';
                    this.billableStatus = employeeEditFormModel.billableStatus || new BillableStatus();
                    this.serviceLine = employeeEditFormModel.serviceLine || new ServiceLine();
                    this.activityName = employeeEditFormModel.activityName || '';
                    this.experienceCurrentRole = employeeEditFormModel.experienceCurrentRole || null;
                    this.totalExperience = employeeEditFormModel.totalExperience || null;
                    this.experienceGaps = employeeEditFormModel.experienceGaps || null;
                    this.academics = employeeEditFormModel.academics ||  new Academics();
                    this.projects = employeeEditFormModel.projects || [];
                    this.skills = employeeEditFormModel.skills || [];
                    this.tools = employeeEditFormModel.tools ||  [];
                    this.definiteRole = employeeEditFormModel.definiteRole || [];
                    this.possibleRole= employeeEditFormModel.possibleRole || [];
                    this.projectTagging = employeeEditFormModel.projectTagging || new ProjectTagging();
        }
}
